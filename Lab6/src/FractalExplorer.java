...
public class FractalExplorer 
{
    ...
    public void createAndShowGUI()
    {
    	...
    	buttonReset = new JButton("Сбросить изображение");
    ...
    public class FractalWorker extends SwingWorker<Object, Object>
    {
    	...
    	public Object doInBackground() throws Exception
    	{
        	...
        	{
        			int count = fractalGenerator.numIterations(FractalGenerator.getCoord(range.x, range.x + range.width, sizeDisplay, x) , FractalGenerator.getCoord(range.y, range.y + range.width, sizeDisplay, coordY));
        			if (count == -1)
        			{
        				RGB[x] = 0;
        			}
